import { registerAllAutoComplete } from "./auto_complete.js"
import { Blockly, getBlocksInToolbox } from "./blockly.mjs"

/**
 * @param {import("./blockly.mjs").WorkspaceSvg} workspace
 */
export function registrerGlobalCategories(workspace){
    registerAllAutoComplete(workspace)
}

/** @type {import("../../node_modules/blockly/core/utils/toolbox.js").ToolboxItemInfo[]} */ 
export default [
    {
        kind: "category",
        name: "🔎Transform",
